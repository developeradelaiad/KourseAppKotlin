...
class Lecture13 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(LecturePhotoData(R.drawable.lecture13page1))
        list.add(LecturePhotoData(R.drawable.lecture13page2))
        list.add(LecturePhotoData(R.drawable.lecture13page3))
        list.add(LecturePhotoData(R.drawable.lecture13page4))
        list.add(LecturePhotoData(R.drawable.lecture13page5))
        list.add(LecturePhotoData(R.drawable.lecture13page6))
